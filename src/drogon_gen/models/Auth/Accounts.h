...
class Accounts
{
  public:
     ...
     */
    explicit Accounts(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Accounts(const Json::Value &pJson) noexcept(false);
     ...
     */
    Accounts(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Accounts, true, false>;
    friend drogon::orm::BaseBuilder<Accounts, false, true>;
    friend drogon::orm::BaseBuilder<Accounts, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Accounts>;
#endif
